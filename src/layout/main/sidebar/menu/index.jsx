  ...
  return (
    <nav className='mt-0.5 mb-1'>
      <NavLink to='/' className='block group'>
        {({ isActive }) => (
          <div className={classNames('inline-flex items-center transition-colors p-3 rounded-full gap-5 group-hover:bg-[#eff3f41a]', {
            'font-bold': isActive
          }
          )}>
            {!isActive && (
            ...
            {isActive && (
              <svg viewBox="0 0 24 24" width={26.25} height={26.25} fill="#ffffff">
                <path
            ...
            <p className='mr-4 text-xl leading-6'>Anasayfa</p>
          </div>
        )}
      </NavLink>
      <NavLink to='/explore' className='block group'>
        {({ isActive }) => (
          <div className={classNames('inline-flex items-center transition-colors p-3 rounded-full gap-5 group-hover:bg-[#eff3f41a]', {
            ...
            <p className='mr-4 text-xl leading-6'>Keşfet</p>
          </div>
        )}
      </NavLink>
      <NavLink to='/notification' className='block group'>
        {({ isActive }) => (
          <div className={classNames('inline-flex items-center transition-colors p-3 rounded-full gap-5 group-hover:bg-[#eff3f41a]', {
            'font-bold': isActive
          }
            ...
            <p className='mr-4 text-xl leading-6'>Bildirimler</p>
          </div>
        )}
      </NavLink>
